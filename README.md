...
- [ ] Deploy as a real-time **web or mobile application** with digital stethoscope integration
- [ ] Replace majority voting with **weighted voting or attention-based aggregation**
- [ ] Expand dataset to include **varied populations and rare disease classes**
- [ ] Improve severity prediction using **longitudinal patient data and risk scoring**

---

---

<p align="center">Made with ❤️ for better respiratory healthcare</p>
